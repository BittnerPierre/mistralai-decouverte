...
def load_store(documents: list[Document], embeddings: OpenAIEmbeddings = None, collection_name=None):
    ...
    if pdfs is not None:
        ...
        for pdf in pdfs:
            ...
            for i, page in enumerate(reader.pages, start=1):
                ...
                docs.append(Document(page_content=clean_text(page.extract_text()), metadata=page_metadata))
        return docs
    else:
        return None